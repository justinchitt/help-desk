...
# Tickets
Ticket.create!(subject: "Internal Server Error", description: "When I try to fetch the current user, I receive unauthorized. I've tried restarting the both my frontend and back end servers. The error keeps occuring.", created_date: "11/20/2021", author: "Sarahi Barraza", status: "completed", completed_admin: "Justin Chittarath", completed_date: "11/21/2021", solution: "The backend team forgot to skip authorization for the show users method, I fixed that.", admin_id: justinchitt.id, submitter_id: sarahbam.id)
